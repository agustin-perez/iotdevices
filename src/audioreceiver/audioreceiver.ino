...
static const char homePage[] PROGMEM = R"({"title": "Technics SA-GX170", "uri": "/", "menu": true, "element": [
      {"name": "header", "type": "ACElement", "value": "<h2 style='text-align:center;color:#2f4f4f;margin-top:10px;margin-bottom:10px'>Technics SA-GX170 setup page</h2>"},
